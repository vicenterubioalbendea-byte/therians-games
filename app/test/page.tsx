...
const animalsData: Record<string, Animal> = {
  ...
  Tiger: { image: "/animals/tiger.png", description: "Fuerza silenciosa y letal." },
  Eagle: { image: "/animals/eagle.png", description: "Visión superior y libertad." },
  Raven: { image: "/animals/raven.png", description: "Mente estratégica y misteriosa." },
  Fox: { image: "/animals/fox.png", description: "Astucia y elegancia mental." },
  Panther: { image: "/animals/panther.png", description: "Sombra poderosa y sigilosa." },
  Dragon: { image: "/animals/dragon.png", description: "Energía primordial indomable." },
  Owl: { image: "/animals/owl.png", description: "Sabiduría profunda." },
  Bear: { image: "/animals/bear.png", description: "Protección y fuerza interior." },
  Serpent: { image: "/animals/serpent.png", description: "Transformación constante." },
  Stag: { image: "/animals/stag.png", description: "Nobleza espiritual." },
  Shark: { image: "/animals/shark.png", description: "Determinación imparable." },
  Horse: { image: "/animals/horse.png", description: "Espíritu libre." },
  Phoenix: { image: "/animals/phoenix.png", description: "Renacimiento eterno." },
  Crow: { image: "/animals/crow.png", description: "Intuición aguda." },
  Lynx: { image: "/animals/lynx.png", description: "Observador silencioso." },
  Hawk: { image: "/animals/hawk.png", description: "Precisión absoluta." },
  Jaguar: { image: "/animals/jaguar.png", description: "Elegancia feroz." },
  Whale: { image: "/animals/whale.png", description: "Profundidad emocional." },
};
